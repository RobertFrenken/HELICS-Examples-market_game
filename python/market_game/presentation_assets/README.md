...
- [market_price_curve_average_demand.svg](market_price_curve_average_demand.svg):
  main piecewise price curve versus average demand per house
- [market_price_curve_total_demand.svg](market_price_curve_total_demand.svg):
  same rule shown as total neighborhood demand for several neighborhood sizes
- [market_price_tiers_reference.svg](market_price_tiers_reference.svg):
